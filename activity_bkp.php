...
<tr>
	...
	<table class="Tbl_Txt_bo" width="70%" cellspacing="1" cellpadding="3" border="0" id="list_activity">
		...
		<tr>
			...
			<a href="activity.php?actid=0">
			<img width="25" border="0" height="26" src="images/back_list.jpg"/>&nbsp;&nbsp;Add new Activity
			</a>
			</td>
		</tr>
			 ...
			 <tr>
			    ...
			    <input type="checkbox" name="isschedule" id="isschedule"   value="1" 
			     ...
			     <tr>
						...
						<input type="button" id="btnsave" class="s_bt" value="Save" onclick="checkall()" />
						<?php
						if(isset($_GET['actid'])) echo "<input type=\"button\" id=\"btndel\" value=\"Delete\" class=\"s_bt\" onclick=\"deleteSch()\" />";
						?>
						<input type="reset" value="Clear"  class="s_bt" />
    ...
    <table align="center" width="100%">
        <tr>
         ...
         <table class="Tbl_Txt_bo" width="75%" align="center" cellspacing="0" cellpadding="0" border="0" id="list_activity">
           ...
           <div align="center" style="overflow:-moz-scrollbars-vertical;overflow-y:scroll; WIDTH: 100%; HEIGHT: 330px; " width="100%">
                <table width="97%" border="0"  id="data" class="main_content_table">
                      
				<tr >
                <th  >Sl No</td>
                <th >Activity</td>
                <th >Description </td>
                <th >Is Schedulable</td>
                <th >Department</td>
