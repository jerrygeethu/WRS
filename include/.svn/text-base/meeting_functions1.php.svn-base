...
if(isset($_POST['editmeeting']))
{
	...
	$employees=(!empty($row['people']))?$row['people']:"";
	$emprow=unserialize($employees);
	foreach($emprow as $dep=>$value)
	{
			foreach($value as $k)	
			{
				$arr_empid[]=$k;
...
{
	echo "m=".$mid=intval($_POST['updatemeetid']);
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							...
							if($row['status']=="allow"){
								...
								$class="style=\"background-color:#FFA500;\"";
									...
									$view.="<tr ".$class."><td>".$row['fullname']."</td>
															...
															<td>".$row['schdate']."</td>
															<td>
															<form name=\"frmedit\" id=\"frmedit\" method=\"post\" action=\"meetings1.php\">";
									$view.="<input type=\"submit\" name=\"viewBtn\" id=\"viewBtn\" value=\"View\"/>";									
									/////////////////Edit meeting/////////////////////
									if(($meetingfrom==$_SESSION['USERID'])&&($row['status']!="allow"))
									{
									$view.="<input type=\"submit\" name=\"editmeeting\" id=\"editmeeting\" value=\"Edit\"/>";
									}
									/////////////////////////////////////////////////////////																		
									if($row['status']=="allow")
									{						
