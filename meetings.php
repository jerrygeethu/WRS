...
// $data=viewmeetings($start,$no_of_rows); 
...
<!-- ====== ================================================= -->
<!-- ====== clockpick  ====== -->
		<link href="js/jquery.clockpick.1.2.8/jquery.clockpick.1.2.8.css" rel="stylesheet" type="text/css" />
		<!--<script type="text/javascript" src="js/jquery.min.js"></script>-->	
		<script type="text/javascript" src="js/jquery.clockpick.1.2.8/jquery.form.js"></script>
		<script language="JavaScript" src="js/jquery.clockpick.1.2.8/jquery.clockpick.1.2.8.js"></script>
		<script language="JavaScript" src="js/jquery.clockpick.1.2.8/jquery.clockpick.1.2.8.min.js"></script>
...
<table width="99%" height="100%" class="leave_table"  border="0" cellspacing="1" cellpadding="1">
    <tr>
        <td width="400px"  valign="top" align="center">
				...
				<table width="100%">
						<tr><td colspan="2" style="color:#FF0000"><?php echo $msg.$msgmeeting.$message.$meetingexists;?></td></tr>
						<tr>
								<td>
								Subject
								</td>
							 <td><textarea style="width:400px; height:50px;" name="meetingtitle" id="meetingtitle" <?php if($flag==1) {echo "readonly=\"yes\"";}?> ><?php echo (!empty($row['title']))?$row['title']:$_POST['meetingtitle'];?></textarea>
								</td>								
						</tr>
						<tr>
   ...
   <img onclick="displayDatePicker('fromdate');" value="select" src="<?php print $_SESSION['FOLDER'];?>/cal.gif" title="Calender"/>
						...
						<tr>
								<td colspan="2" align="center"><?php  if(($errDate!="")|| ($errTime!="")||($errdatesch!="")) { echo $errDate."  ".$errTime." ".$errdatesch; }?></td>
						</tr>
					 ...
					 <tr>
								...
								<td>
								<input type="text" name="venue" id="venue" value="<?php echo (!empty($row['venue']))?$row['venue']:$_POST['venue'];?>" <?php if($flag==1) {echo "readonly=\"yes\"";}?>/>
								</td>
						</tr>
							<tr>
								<td colspan="2" align="center"><?php  if($errVenue!="") { echo $errVenue; }?></td>
						</tr>
						...
						<tr>
						 ...
						 People
								...
								<?php }else {?>					
								<!--<select name="people[]" id="people[]" multiple="true" style="width:300px; height:200px;">-->
								<select name="people[]" id="people" multiple="true">
								<?php
								print deptlist($arr_empid);
								?>
								</select>	
								<?php } ?>	
								</td>
						...
						<tr>
							...
							<?php
					//	if((isset($_POST['editBtn']) &&$flag==1)||(isset($_POST['update']) &&$flag==1)){
						if($row['status']=="allow") {		
						?>	
						<tr>
								<td>
						 File
								...
								<td>
								<input type="file" name="uploadedfile" id="uploadedfile"/>[excel|msword|pdf]
						...
						<tr>
						 ...
						 Feedback
								...
								<td>
								<textarea style="width:400px; height:100px;" name="feedback" id="feedback"><?php echo (!empty($row['conv']))?$row['conv']:$_POST['feedback'];?></textarea>								
								</td>
						</tr>
						...
						<tr>
						 ...
						 Comments
								...
								<td>
									<textarea style="width:400px; height:100px;" name="comments" id="comments"><?php if(!empty($row['comments'])){echo $row['comments'];}				elseif((empty($row['comments']))and(!empty($row['notification']))){echo $row['notification'];}else{echo $_POST['comments'];}?></textarea>	
								</td>
						</tr>
						<?php }?>
						...
						<input type="hidden" name="hid_mid" id="hid_mid" value="<?php echo $row['meetingid']; ?>" />
						<?php 
						}else if($flag==""){
						?>	
        ...
        <td valign="top" align="center">
				...
				<table  border="1" class="leave_detials" width="98%" >
						<tr>
						<th>Scheduled by</th><th>Title</th><th>Date</th><th>Options</th>						
						</tr>	
						<?php
						 print viewmeetings(); 
