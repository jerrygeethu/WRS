...
require_once('include/outbox_functions.php');
...
<div id="main_div">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" summary=" ">
    ...
    <tr>
      <td height="580" valign="top" class="home_main_td" align="left" >
      
      <h2>OUTBOX</h2>
      
      <br/>  
<a href="compose.php" title="google.com" class="example2demo" name="windowX">

        <input type="submit" value="COMPOSE MAIL"  id="p"  name="p" class="mail_button"> </a> 
      <br/>  
<!-- ============================================================================================= -->
 <table  width="98%"  border="0" cellpadding="2" cellspacing="2" >
	...
	if(isset($resultmail) and $resultmail->num_rows>0) {
		?>
...
<?php 
 ...
 $n="-";
 		while($row =$resultmail->fetch_assoc()){
 			...
 			print " <tr> 
        <td class=\"".$class."\" width=\"50px\" >
        ".$i."
        </td>
        <td class=\"".$class."\"  width=\"100px\" >
        ".ymdToDmy($row['senddate'],$n,1)."
        </td>
        <td class=\"".$class."\" >
        <a href=\"outbox.php?mail=".trim($row['emailid'])."\" >".$row['subject']."</a>
        </td> 
 			</tr> 	"; 
		}
}
