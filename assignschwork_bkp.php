...
<!-- side menu Left start edietd by  **** hmsqt@gmail.com **** -->
    <tr>
      <td width="159" rowspan="2" align="left" valign="top"  class="menu_back"><table width="159" border="0" cellspacing="0" cellpadding="0" class="menu_back">
        <?php 
...
<!-- side menu Left end	edietd by **** hmsqt@gmail.com **** -->
	...
	<td align="center">
	 ...
	 <form id="frmschwork" name="frmschwork" method="POST"  action="assignschwork.php"  >
			    ...
			    <table width="60%" class="main_content_table_no_width" border="0" id="list_employees">
				    
				 
				<tr align="left">
		        <td colspan="4" height="30px" class="table_heading"><a href="assignschwork.php?schid=0" >
		       Add new Schedule</a></td>
	            </tr>	
		...
		<!-- select box-->
		 <tr>
			       ...
			       echo $empl = $schactivity->get_depemployee( $supid,$departid,$schactrow['scheduleid']);
			        // } 
                      // else
                      // {
			     ...
			     <label for="schfromdate" >Valid from : </label></td>
							<td colspan="1" align="left" ><input type="hidden" id="today"  value="<?php echo date("d/m/Y");?>" />
...
<textarea id="schcomment" name="schcomment" style='width:220px;height:60px;'><?php echo $schactrow['schcomment'] ?></textarea>
			     ...
			     <tr>
						...
						*/
						...
						if((isset($_GET['schid']))&&($_GET['schid']!=0)) echo "<input type=\"button\" id=\"btndel\" value=\"Delete\" onclick=\"deleteSch()\" />";
     ...
     <table class="Tbl_Txt_bo" cellspacing="0" cellpadding="0" border="0" width="60%"  >
        <tr>
           ...
           <?php if(isset($_GET['error'])){
            ...
            <tr width="100%">
                  <td colspan="6" height="30px" align="center" class="table_heading" >Schedule List</td>
            </tr>
            
            <tr width="100%">
              <td colspan="6" align="center">
                <div width="98%" align="center" style="overflow:-moz-scrollbars-vertical;overflow-y:scroll; WIDTH: 100%; HEIGHT: 330px; ">
            <table width="97%"  class="main_content_table" border="0" align="center"  id="data">
                 <tr width="100%" class="subhead" >
...
<!-- start footer coded by *** hmrsqt@gmail.com *** -->
   <tr>
      <td height="30" colspan="4"  class="Footer_txt">
