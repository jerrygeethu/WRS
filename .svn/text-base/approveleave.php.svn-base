...
$_SESSION['SEL_LINK']="APL";
require_once('include/parameters.php');
require_once('include/approve_functions.php');
...
<div id="main_div">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="0" summary=" ">
    ...
    <tr>
      ...
      <td width="100%" height="30px" valign="top"  class="head_with_back_button"><?php print get_table_link("Approve Leave","approve_lvicon.gif");?>
      </td>
    </tr>
    <tr>
      ...
      Leave Details
              ...
              ?>
      <tr>
              <td colspan="5" id="validate" name="validate"><?php 
              print $message;
              ?></td>
              </tr>			  
			  <?php 
