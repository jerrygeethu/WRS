...
<div id="main_div">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" summary=" ">
    ...
    <tr>
      ...
      <form action="logincheck.php" autocomplete="off" onsubmit="return checkall();" method="post" enctype="multipart/form-data" id="frmlogin">
        <table width="30%" border="0" cellspacing="0" cellpadding="0">
          <tr><td colspan="2" align="right">
  <div align="right" class="button-primary"><a href="../itrequests" style="color:#FFFFFF;letter-spacing:1px;" title="Send a service request to IT">IT request</a></div> 
  </td></tr>
          <tr>
          ...
          <tr>
            ...
            <td width="66%" background="<?php print $image_folder;?>tbl_bg.jpg"  style="border-bottom:#666666 1px solid; border-right:#666666 1px solid;"><table width="100%" border="0" cellspacing="5" cellpadding="0">
              ...
              <tr>
                ...
                <td align="left" valign="middle" nowrap><label>
                  <input name="button" type="submit"   class="s_bt"  title=" Click To Login"   value="Login" />
                  </label>
                    <label>
