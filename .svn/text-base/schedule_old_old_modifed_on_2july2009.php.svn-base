...
$get_date=$_POST['get_pre_report_date'];
...
// not today 
 $enter_report_query =  " select "
																...
																." sca.activitycomment as comment , "
	...
	$editable="";
	 ...
	 $enter_report_query = " select "
							        ...
							        ." where "
							        	."  ( sca.activitystatus = 'running' OR sca.activitystatus = 'pending') "
						  	        ." and sca.employeeid='".$_SESSION['USERID']."' "
						  	        ." and sca.activityfromdate<='".date('Y-m-d')."'  "
	          						." and sca.activitytodate>='".date('Y-m-d')."' "
	          						." and  sca.scheduleid=sch.scheduleid";
...
$select_misc_report_query = " select "
															...
															." where "
																...
																." sact.employeeid='".$_SESSION['USERID']."' "
																." and "
																."  DATE_FORMAT( act.logdate, '%Y-%m-%d' )= '".date('Y-m-d')."' "
																." and "
																." sact.scheduleid is NULL ";
...
-->
      ...
      if(($num_c%2)<1) $class=" class=\"even\" ";else  $class=" class=\"odd\" ";
      		...
      		$act_type=$row['type'];
      		$act_schid=$row['schid'];
     			$act_comment=ucwords($row['comment']);
     ...
     $query_log=" select "
									...
									." empactivitylog, "
									." loglock, "
									."   supremarks1 as com_emp "
     					." from "
     							." activitylog "
     					." where "
     							." schactivityid='".$act_id."' and "
     							." logdate like '".$current_date."%' ";
  //print $query_log;
...
if(/(NEW).+/.test(id)){
	...
	// case of editing already entered report
